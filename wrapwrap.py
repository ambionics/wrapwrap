...
class Generator:
    ...
    def add3_swap(self, triplet: str):
    ...
    def b64e(self, value: str, strip: bool = False) -> str:
    ...
    def set_lsbs(self, chunk: str) -> str:
        ...
        return chunk[:2] + alphabet[index + 3]

    def align_right(self, input_str: str, n: int, p: str = None) -> str:
    ...
    def align_left(self, input_str: str, n: int, p: str = None) -> str:
